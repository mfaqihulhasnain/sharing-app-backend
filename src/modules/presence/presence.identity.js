...
import { userPublicSelect } from "../users/user.model.js";
import {
...
const resolvePresenceViewerContext = async ({
  authorizationHeader,
  cookieHeader,
}) => {
  ...
  if (authUser) {
    return {
      viewer: toPresenceViewerFromUser(authUser),
      guestId: null,
      setGuestCookie: null,
    };
  }
  ...
  return {
    viewer: toPresenceViewerFromGuest({ guestId }),
    guestId,
